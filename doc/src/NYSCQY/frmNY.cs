...
namespace NYSCQY
{
	public class frmNY : Form
	{
		...
		private RadioButton radNewXZ;
		private RadioButton radNewDJ;
		...
		{
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(frmNY));
			...
			this.radNewXZ = new RadioButton();
			this.radNewDJ = new RadioButton();
			...
			this.panelmenu.Location = new Point(0, 91);
			this.panelmenu.Name = "panelmenu";
			this.panelmenu.Size = new Size(185, 491);
			...
			this.userManu1.Size = new Size(185, 491);
			...
			this.paneltitle_left.TabIndex = 15;
			...
			this.paneltitle_middle.TabIndex = 16;
			...
			this.paneltop_left.TabIndex = 18;
			...
			this.panelcondition.Controls.Add(this.radNewXZ);
			this.panelcondition.Controls.Add(this.radNewDJ);
			...
			this.panelcondition.Location = new Point(1, 30);
			this.panelcondition.Name = "panelcondition";
			this.panelcondition.Size = new Size(643, 119);
			this.panelcondition.TabIndex = 1;
			this.cboDJSQ.Font = new Font("宋体", 10.5f, FontStyle.Regular, GraphicsUnit.Point, 134);
			...
			this.cboDJSQ.Location = new Point(500, 9);
			this.cboDJSQ.Name = "cboDJSQ";
			this.cboDJSQ.Size = new Size(140, 22);
			this.cboDJSQ.TabIndex = 13;
			this.label5.BackColor = Color.Transparent;
			this.label5.Font = new Font("宋体", 10.5f, FontStyle.Regular, GraphicsUnit.Point, 134);
			this.label5.Location = new Point(433, 13);
			this.label5.Name = "label5";
			this.label5.Size = new Size(63, 14);
			this.label5.TabIndex = 12;
			this.label5.Text = "登记时期";
			this.radNewXZ.AutoSize = true;
			this.radNewXZ.BackColor = Color.Transparent;
			this.radNewXZ.Font = new Font("宋体", 10.5f, FontStyle.Regular, GraphicsUnit.Point, 134);
			this.radNewXZ.Location = new Point(558, 44);
			this.radNewXZ.Name = "radNewXZ";
			this.radNewXZ.Size = new Size(53, 18);
			this.radNewXZ.TabIndex = 11;
			this.radNewXZ.Text = "新续";
			this.radNewXZ.UseVisualStyleBackColor = false;
			this.radNewDJ.AutoSize = true;
			this.radNewDJ.BackColor = Color.Transparent;
			this.radNewDJ.Font = new Font("宋体", 10.5f, FontStyle.Regular, GraphicsUnit.Point, 134);
			this.radNewDJ.Location = new Point(500, 44);
			this.radNewDJ.Name = "radNewDJ";
			this.radNewDJ.Size = new Size(53, 18);
			this.radNewDJ.TabIndex = 10;
			this.radNewDJ.Text = "新登";
			this.radNewDJ.UseVisualStyleBackColor = false;
			...
			this.radAll.Location = new Point(441, 44);
			...
			this.btnReset.Location = new Point(316, 79);
			this.btnReset.Name = "btnReset";
			this.btnReset.Size = new Size(113, 29);
			this.btnReset.TabIndex = 3;
			this.btnReset.UseVisualStyleBackColor = true;
			this.btnReset.Click += new EventHandler(this.btnReset_Click);
			this.btnSearch.Font = new Font("宋体", 10.5f, FontStyle.Regular, GraphicsUnit.Point, 134);
			this.btnSearch.Location = new Point(69, 79);
			this.btnSearch.Name = "btnSearch";
			this.btnSearch.Size = new Size(113, 29);
			...
			this.cboNYLB.Location = new Point(75, 42);
			this.cboNYLB.MaxDropDownItems = 15;
			this.cboNYLB.Name = "cboNYLB";
			this.cboNYLB.Size = new Size(140, 22);
			this.cboNYLB.TabIndex = 8;
			this.label4.BackColor = Color.Transparent;
			this.label4.Font = new Font("宋体", 10.5f, FontStyle.Regular, GraphicsUnit.Point, 134);
			this.label4.Location = new Point(10, 46);
			...
			this.txtDJMC.Location = new Point(285, 9);
			this.txtDJMC.Name = "txtDJMC";
			this.txtDJMC.Size = new Size(140, 23);
			...
			this.txtDJZH.Location = new Point(75, 9);
			this.txtDJZH.Name = "txtDJZH";
			this.txtDJZH.Size = new Size(140, 23);
			...
			this.paneldata.Location = new Point(13, 102);
			this.paneldata.Name = "paneldata";
			this.paneldata.Size = new Size(612, 185);
			this.paneldata.TabIndex = 13;
			this.gridControl1.Dock = DockStyle.Fill;
			this.gridControl1.Location = new Point(0, 0);
			this.gridControl1.MainView = this.gridView1;
			this.gridControl1.Name = "gridControl1";
			this.gridControl1.Size = new Size(612, 185);
			...
			this.panelright.Location = new Point(194, 91);
			this.panelright.Name = "panelright";
			this.panelright.Size = new Size(652, 490);
			...
			this.panelwhite.Location = new Point(10, 155);
			this.panelwhite.Name = "panelwhite";
			this.panelwhite.Size = new Size(634, 299);
			...
			this.panelbutton.Location = new Point(13, 47);
			...
			this.pictureBox_sum.Click += new EventHandler(this.pictureBox9_Click);
			...
			this.pictureBox_view.Click += new EventHandler(this.pictureBox8_Click);
			...
			this.pictureBox_sort.Click += new EventHandler(this.pictureBox7_Click);
			...
			this.pictureBox_filter.Click += new EventHandler(this.pictureBox6_Click);
			...
			this.pictureBox_right.Location = new Point(613, 1);
			...
			this.panel_middle.Location = new Point(70, 1);
			this.panel_middle.Name = "panel_middle";
			this.panel_middle.Size = new Size(328, 28);
			this.panel_middle.TabIndex = 15;
			...
			this.pictureBox_left.Location = new Point(1, 1);
			...
			this.pictureBox_left.TabIndex = 14;
			...
			base.Name = "frmNY";
			this.Text = "农药登记查询及名称互检";
			base.WindowState = FormWindowState.Maximized;
			base.Load += new EventHandler(this.frmNY_Load);
			base.Resize += new EventHandler(this.frmNY_Resize);
		...
		private void frmNY_Load(object sender, EventArgs e)
		{
			this.tblResult.TableName = "Result";
			this.SetHeaders();
			this.txtDJZH.Focus();
			this.userManu1.navBarControl1.Items[0].Appearance.ForeColor = Color.FromArgb(177, 81, 28);
		}
		...
		{
			MessageBox.Show(this.panelmenu.Height.ToString());
			MessageBox.Show(this.userManu1.Height.ToString());
		}
		...
		private void frmNY_Resize(object sender, EventArgs e)
		{
