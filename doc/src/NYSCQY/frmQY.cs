...
namespace NYSCQY
{
	public class frmQY : Form
	{
		...
		{
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(frmQY));
			...
			this.label6.Location = new Point(174, 13);
			...
			this.panelcondition.Size = new Size(561, 126);
			...
			this.cboProvince.Location = new Point(195, 10);
			this.cboProvince.Name = "cboProvince";
			this.cboProvince.Size = new Size(107, 22);
			this.cboProvince.TabIndex = 17;
			this.btnSearch.Location = new Point(16, 87);
			...
			this.btnReset.Location = new Point(79, 87);
			...
			this.lblCount.Location = new Point(315, 58);
			...
			this.txtDWMC.Size = new Size(492, 23);
			...
			this.paneldata.Location = new Point(34, 179);
			this.paneldata.Name = "paneldata";
			this.paneldata.Size = new Size(252, 107);
			this.paneldata.TabIndex = 37;
			this.gridControl1.Dock = DockStyle.Fill;
			this.gridControl1.Location = new Point(0, 0);
			this.gridControl1.MainView = this.gridView1;
			this.gridControl1.Name = "gridControl1";
			this.gridControl1.Size = new Size(252, 107);
			...
			this.panelmenu.Location = new Point(1, 181);
			this.panelmenu.Name = "panelmenu";
			this.panelmenu.Size = new Size(177, 381);
			...
			this.paneltitle_right.Location = new Point(542, 3);
			...
			this.panelright.Location = new Point(209, 80);
			this.panelright.Name = "panelright";
			this.panelright.Size = new Size(569, 482);
			...
			this.panelwhite.Location = new Point(3, 169);
			this.panelwhite.Name = "panelwhite";
			this.panelwhite.Size = new Size(561, 305);
			...
			this.pictureBox_right.Location = new Point(526, 3);
			...
			this.panel_middle.Location = new Point(70, 3);
			this.panel_middle.Name = "panel_middle";
			this.panel_middle.Size = new Size(328, 28);
			this.panel_middle.TabIndex = 39;
			this.label5.BackColor = Color.Transparent;
			this.label5.Font = new Font("宋体", 10.5f, FontStyle.Bold, GraphicsUnit.Point, 134);
			this.label5.Location = new Point(41, 7);
			this.label5.Name = "label5";
			this.label5.Size = new Size(253, 14);
			this.label5.TabIndex = 1;
			this.label5.Text = "生产企业查询";
			this.pictureBox_left.Location = new Point(1, 3);
			...
			base.Load += new EventHandler(this.frmQY_Load);
			base.Resize += new EventHandler(this.frmQY_Resize);
		...
		public frmQY()
		{
			...
			this.SetGridControl();
			this.userManu1.navBarItem14.Appearance.ForeColor = Color.FromArgb(177, 81, 28);
		}
		...
		private void frmQY_Load(object sender, EventArgs e)
		{
		...
		private void frmQY_Resize(object sender, EventArgs e)
		{
