...
namespace NYSCQY
{
	public class frmJXY : Form
	{
		...
		private ComboBox cboXYGJ;
		private Label label8;
		private ComboBox cboJYGJ;
		...
		public frmJXY()
		{
			...
			this.SetGridControl();
			this.userManu1.navBarItem12.Appearance.ForeColor = Color.FromArgb(177, 81, 28);
		}
		private void btnSearch_Click(object sender, EventArgs e)
		{
			...
			string text2 = "E19 is not null  or E20 is not null or E21 is not null";
			...
			if (this.cboJYGJ.Text.Trim() != "")
			{
				if (text == "")
				{
					text = "E20 like '%" + this.cboJYGJ.Text.Trim() + "%'";
				}
				else
				{
					text = text + " and E20 like '%" + this.cboJYGJ.Text.Trim() + "%'";
				}
			}
			if (this.cboXYGJ.Text.Trim() != "")
			{
				if (text == "")
				{
					text = "E21 like '%" + this.cboXYGJ.Text.Trim() + "%'";
				}
				else
				{
					text = text + " and E21 like '%" + this.cboXYGJ.Text.Trim() + "%'";
				}
			}
			...
			if (array2.Length > 0)
			{
				...
				for (int i = 0; i < array2.Length; i++)
				{
					...
					dataRow["E19"] = array2[i]["E19"];
					dataRow["E20"] = array2[i]["E20"];
					dataRow["E21"] = array2[i]["E21"];
		...
		private void SetHeaders()
		{
			...
			this.tblResult.Columns.Add("E19");
			this.tblResult.Columns.Add("E20");
			this.tblResult.Columns.Add("E21");
		}
		private void SetGridControl()
		{
			...
			this.gridView1.Columns[0].Caption = "中文通用名";
			...
			this.gridView1.Columns[1].Caption = "英文通用名";
		...
		private void frmJXY_Resize(object sender, EventArgs e)
		{
